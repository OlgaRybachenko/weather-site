...
import { getPressureMn, getTime } from '@/method'
...
.card
  ...
  &-pic
    ...
    &--wind
      background-image: url('./src/assets/imgvue/equalizer (2).png')

    &--pressure
      background-image: url('./src/assets/imgvue/barometer.png')

    &--sun
      background-image: url('./src/assets/imgvue/images-removebg-preview 1.png')
...
.state
  ...
  &-pic
    ...
    height: 20px
    margin-bottom: 6px
    background: url('./src/assets/imgvue/sun.svg') no-repeat 50% 50%
...
.card-small
  ...
  &-pic
    ...
    &--wind
      background-image: url('./src/assets/imgvue/gusts.svg')

    &--pressure
      background-image: url('./src/assets/imgvue/humidity.svg')

    &--sun
      background-image: url('./src/assets/imgvue/cloud.svg')
